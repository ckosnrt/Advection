...
from BasicAndAlternativeSchemes_Final import Schemes
...
def animate(nt, ax, x, nx, dx, dt, a, b, c, u, ICnumber):
    ...
    analytic, TVD = Schemes(x, nx, dx, nt, dt, a, b, c, u, ICnumber, SNumber='TVD')
    ...
    tvd, = plt.plot(x, TVD, color='orange', label='TVD')
